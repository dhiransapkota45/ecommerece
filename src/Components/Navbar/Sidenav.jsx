            ...
            {hamburger && <div onClick={()=>setHamburger(false)} className=' fixed z-40 top-0 w-full h-screen bg-black bg-opacity-60'></div>}
            {
                <div id='offcanvas' className={` fixed top-0 w-full sm:w-96 z-50 h-full  bg-gradient-to-t bg-white ${hamburger ? "left-0" : " -left-full sm:-left-96 "} duration-500`}>
                    ...
                    <div className='flex divide-y flex-col items-center py-5 px-3  font-semibold '>
                        <NavLink className=" p-4 w-full text-center " to="/" > Home</NavLink>
                        <NavLink className=" p-4 w-full text-center" to="/shop"> Shop</NavLink>
                        <NavLink className=" p-4 w-full text-center" to="/about"> About Us</NavLink>
                        <NavLink className=" p-4 w-full text-center" to="/contact"> Contact</NavLink>
                        <NavLink className=" p-4 w-full flex justify-center" to="/cart"  >
                            <FiShoppingCart className=' text-xl ' />
                        </NavLink>
                        <NavLink className=" p-4 w-full flex justify-center" to="/wishlist"  >
                            <AiOutlineHeart className=' text-xl' />
                        </NavLink>
                        <NavLink className=" p-4 w-full flex justify-center" to="/account">
