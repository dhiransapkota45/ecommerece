            ...
            <div className=' w-full flex flex-col justify-center items-center mb-20'>
                ...
                <form className=' w-3/5'>
                    ...
                    <div className=' grid grid-cols-2 gap-6 my-5'>
                        <input className='border border-gray-800 outline-none p-2 col-span-1' type="text" placeholder='first name' />
                        <input className='border border-gray-800 outline-none p-2 col-span-1' type="text" placeholder='Last name' />
                    </div>
                    ...
                    <div className='flex justify-center'>
                        <button className='font-bold text-white bg-gradient-to-t from-[#AB40FF] to-[#7D89FF] w-36 p-2 '>Send</button>
                    </div>
